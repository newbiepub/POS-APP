            ...
            <View style={styleHome.container}>
                <View style={[{
                    ...
                    <View style={{flex: 4, paddingHorizontal: 10}}>
                        <Text style={styleBase.font14}>Ghi chú</Text>
                    </View>
                    <View style={[{
                        flex: 6,
                        flexDirection: 'row',
                        ...
                        <Text numberOfLines={1} style={[styleBase.font32, this.state.customAmount == 0 && style.colorWhenNull]}>{this.numberwithThousandsSeparator(this.state.customAmount)}</Text>
                ...
                <View style={{flex: 2, flexDirection: 'row'}}>
                    ...
                    <TouchableWithoutFeedback onPress={() => {this.state.customAmount > 0 &&  this.changeCustomAmount(11)}}>
                        <View style={[{flex: 1}, styleHome.borderButtonCustomAmount, styleHome.textCenterOfTheBox]}>
                            <Ionicons name={"md-arrow-back"} style={[styleBase.font32, this.state.customAmount == 0 && style.colorWhenNull]}/>
                        </View>
                    </TouchableWithoutFeedback>
                </View>
                <View style={{flex: 2, flexDirection: 'row'}}>
                    ...
                    <View style={[{flex: 1}, styleHome.borderButtonCustomAmount, styleHome.textCenterOfTheBox]}>
                        <Text style={styleBase.font32}> + </Text>
                    </View>
                </View>
            </View>
        )
