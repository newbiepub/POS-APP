...
export async function createCategory(payload) {
    try {
        ...
        let response = await fetch(`${config.api}/company/api/category/create?access_token=${token.access_token}`, {
            method: "POST",
            headers: {
...
export async function updateCategory(categoryId, payload) {
    try {
        ...
        let response = await fetch(`${config.api}/company/api/category/update?access_token=${token.access_token}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export async function removeCategory (categoryId) {
    try {
        ...
        let response = await fetch(`${config.api}/company/api/category/remove?access_token=${token.access_token}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
